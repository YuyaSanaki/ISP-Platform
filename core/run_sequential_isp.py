...
plus a simultaneous OSKM4 baseline. Used by BBRC sequential OSKM configs.

Usage:
  python3 core/run_sequential_isp.py --config core/config/sequential_isp.yaml
  python3 core/run_sequential_isp.py --config analysis/bbrc_oskm/configs/sequential_oskm/isp_human_native.yaml
